    ...
    return (
        ...
        >
            <div className="flex items-center justify-between px-4 sm:px-6 mb-4">
                <h2 id="reports-heading" className="text-2xl font-semibold tracking-tight text-black">
                    {title}
                </h2>
                    ...
                    >
                        <div className="group cursor-pointer">
                            ...
                            <div className="flex items-center gap-3">
                                <h4 className="font-semibold text-black text-sm sm:text-base">{report.quarter}</h4>
                                {report.isNew && (
